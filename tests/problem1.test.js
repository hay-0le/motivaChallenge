...
const { createDateIntervals } = require('../problem1.js');
...
describe('Tests for correct data types:', () => {
    ...
    it('createDateIntervals returns an array', () => {
        let result = createDateIntervals('2019-12-14 06:14:56', '2020-02-14 06:14:56', 7);
        expect(Array.isArray(result)).to.equal(true);
    })

    it('createDateIntervals is a function', () => {
        expect(typeof createDateIntervals === 'function').to.equal(true);
    })
})
...
describe('Tests for correct input:', () => {
    ...
    it('Start date must be earlier than end date', () => {
        let result = createDateIntervals('2022-12-14 06:14:56', '2020-02-14 06:14:56', 7);
    ...
    it('Should return one tuple in an array, if periodOfDays is more than different between start and end', () => {
        let result = createDateIntervals('2019-12-14 06:14:56', '2020-02-14 06:14:56', 90)
        
        expect(arraysMatch(result, [ [ '2019-12-14', '2020-2-14' ] ])).to.equal(true);
    })

    it('Both dates are correctly formatted', () => {
        let result = createDateIntervals('19-12-14 06:14:56', '2020-02-14 06:14:56', 90)
